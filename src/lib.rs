...
//!
//! This crate is the Rust realization of Family A of the research line,
//! honoring the runtime-computability discipline of `SUPERTASK_BOUNDARY.md`
//! (every budget finite, every `predict`/`learn`/`revert` terminating) and
//! the revert-exactness contract of the retired Python prototype's
//! `xi_rollouts.py` (root log-probability must be restored after every
//! imagined rollout — here restored *bit-exactly*).
//!
//! Mixture components:
